...
def Save_mat(epoch , output_dim , datasets , query_labels , retrieval_labels , query_img , retrieval_img , save_dir='..' , mode_name="DRKDH",map=0):
    '''
    save_dir: 保存文件的目录路径
    output_dim: S输出维度
    datasets: 数据集名称
    ...
    mode_name: 模型的名称
    '''
    # 1. 处理 query_img 和 retrieval_img（假设是 GPU 张量）
